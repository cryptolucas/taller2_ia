...
def backtracking_search(csp: DroneAssignmentCSP) -> dict[str, str] | None:
    ...
    def recursive_backtracking(csp, assignment):
      ...
      unassigned_var = csp.get_unassigned_variables(assignment)[0]
      
      for choice in csp.domains[unassigned_var]:
        if csp.is_consistent(unassigned_var, choice, assignment):
          csp.assign(unassigned_var, choice, assignment)
    ...
    assignment = {}
    return recursive_backtracking(csp, assignment)
